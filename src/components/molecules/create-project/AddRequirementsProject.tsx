      ...
      <style jsx>{`
        .progress-bar-tech {
          background: linear-gradient(
            -90deg,
            #04ab5b ${parseInt(valueTech) * -1}%,
            #289038 ${parseInt(valueTech)}%
          );
          width: ${parseInt(valueTech) * 2.9}px;
        }
      `}</style>
        ...
        <div className="mini-content-add-requirements">
          <div className="container-select-project">
            <div className="container-select-project-two">
              <div className="content-percent-project">
                <span className="percent-project">{parseInt(valueTech)}%</span>
              </div>
            ...
            >
              ...
              <path
                d="M13.3247 12.5757L14.0082 23.5112C14.0406 24.1431 14.5003 24.6048 15.1017 24.6048H21.3897C21.9935 24.6048 22.4446 24.1431 22.4832 23.5112L23.1667 12.5757"
                stroke="#FAFAFA"
